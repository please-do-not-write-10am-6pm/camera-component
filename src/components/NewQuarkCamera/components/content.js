...
class VideoContent extends Component {
  ...
  takePhoto = () => {
    ...
    canvas
      .getContext("2d")
      .drawImage(this.videoNode, 0, 0, canvas.width, canvas.height);
    var nImg = new Image();
    nImg.src = canvas.toDataURL();
    images.push(nImg);
    let cur = images.length - 1;

    this.setState({ images: images, currentImageIndex: cur }, () => {
    ...
    popupContext.drawImage(
      ...
      0,
      0,
      this.popupCanvas.width,
      this.popupCanvas.height
    );
        ...
        <div className="CameraBottom">
          ...
          <div
            ...
            style={{
              width: "60px",
              height: "60px",
              boxShadow: "0px 0px 0px 3px black, 0px 0px 3px 3px white",
            }}
              ...
              {this.state.Mediadivces.map((device, index) => {
                return (
                  <div
                    ...
                    onClick={() => this.SelectCamera(device.deviceId)}
                  >
                    {this.truncateString(device.label, 25)}
                  </div>
                );
              })}
            </div>
